...
const CarouselItem = React.forwardRef((_a, ref) => {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (<div ref={ref} role="group" aria-roledescription="slide" className={(0, utils_1.cn)("min-w-0 shrink-0 grow-0 basis-full" ? "pl-4" : "pt-4", className)} {...props}/>);
});
...
const CarouselPrevious = React.forwardRef((_a, ref) => {
    ...
    return (<button_1.Button ref={ref} variant={variant} size={size} className={(0, utils_1.cn)("absolute  h-8 w-8 rounded-full", orientation === "horizontal"
            ...
            : "-top-10 left-1/2 -translate-x-1/2 rotate-90", className)} disabled={!canScrollPrev} onClick={scrollPrev} {...props}>
...
const CarouselNext = React.forwardRef((_a, ref) => {
    ...
    return (<button_1.Button ref={ref} variant={variant} size={size} className={(0, utils_1.cn)("absolute h-8 w-8 rounded-full", orientation === "horizontal"
            ...
            : "-bottom-10 left-1/2 -translate-x-1/2 rotate-90", className)} disabled={!canScrollNext} onClick={scrollNext} {...props}>
