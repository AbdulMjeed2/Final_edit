...
exports.TaskContentForm = void 0;
...
const TaskContentForm = ({ initialData, courseId, taskId }) => {
    ...
    const onSubmit = (values) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            yield axios_1.default.patch(`/api/courses/${courseId}/task/${taskId}`, values);
            react_hot_toast_1.default.success("تم تحديث المهمة");
            toggleEdit();
            router.refresh();
        }
        catch (_a) {
    ...
    return (<div className="mt-6 border bg-slate-100 rounded-md p-4">
      ...
      {!isEditing && (<div className={(0, utils_1.cn)("text-sm mt-2", !initialData.content && "text-slate-500 italic")}>
          {!initialData.content && "بدون وصف"}
          {initialData.content && (<div className="ck ck-reset ck-editor ck-rounded-corners" role="application" dir="rtl" lang="ar" aria-labelledby="ck-editor__label_e5ec4d5affe02b22e9b21b94cdac3388f">
            <div className="ck ck-editor__main" role="presentation">
              <div style={{ border: "none" }} className="ck-blurred ck ck-content ck-editor__editable ck-rounded-corners ck-editor__editable_inline ck-read-only" lang="ar" dir="rtl" role="textbox" aria-label="Editor editing area: main" contentEditable="false">
                ...
                <FroalaEditorView_1.default model={form.getValues().content}/>
...
exports.TaskContentForm = TaskContentForm;
