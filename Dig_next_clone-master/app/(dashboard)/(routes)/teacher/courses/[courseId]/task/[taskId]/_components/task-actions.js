...
const TaskActions = ({ disabled, courseId, taskId, isPublished, }) => {
    ...
    const onClick = () => __awaiter(void 0, void 0, void 0, function* () {
        try {
            setIsLoading(true);
            if (isPublished) {
                yield axios_1.default.patch(`/api/courses/${courseId}/task/${taskId}/unpublish`);
                react_hot_toast_1.default.success("المهمة غير منشورة");
            }
            else {
                yield axios_1.default.patch(`/api/courses/${courseId}/task/${taskId}/publish`);
                react_hot_toast_1.default.success("تم نشر المهمة");
            }
            router.refresh();
        }
        catch (_a) {
    ...
    const onDelete = () => __awaiter(void 0, void 0, void 0, function* () {
        try {
            setIsLoading(true);
            yield axios_1.default.delete(`/api/courses/${courseId}/task/${taskId}`);
            react_hot_toast_1.default.success("تم حذف المهمة");
            router.refresh();
