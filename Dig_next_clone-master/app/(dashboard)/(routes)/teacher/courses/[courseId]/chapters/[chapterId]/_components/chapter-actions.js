...
const ChapterActions = ({ disabled, courseId, chapterId, isPublished }) => {
    ...
    const onClick = () => __awaiter(void 0, void 0, void 0, function* () {
        try {
            setIsLoading(true);
            if (isPublished) {
                yield axios_1.default.patch(`/api/courses/${courseId}/chapters/${chapterId}/unpublish`);
                react_hot_toast_1.default.success("الفصل غير منشور");
            }
            else {
                yield axios_1.default.patch(`/api/courses/${courseId}/chapters/${chapterId}/publish`);
                react_hot_toast_1.default.success("تم نشر الفصل");
            }
            router.refresh();
        }
        catch (_a) {
    ...
    const onDelete = () => __awaiter(void 0, void 0, void 0, function* () {
        try {
            setIsLoading(true);
            yield axios_1.default.delete(`/api/courses/${courseId}/chapters/${chapterId}`);
