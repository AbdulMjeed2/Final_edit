...
const QuizActions = ({ disabled, chapterId, courseId, quizId, isPublished, }) => {
    ...
    const onClick = () => __awaiter(void 0, void 0, void 0, function* () {
        try {
            setIsLoading(true);
            if (isPublished) {
                yield axios_1.default.patch(`/api/courses/${courseId}/chapters/${chapterId}/quiz/${quizId}/unpublish`);
                react_hot_toast_1.default.success("تم إلغاء نشر النشاط");
            }
            else {
                yield axios_1.default.patch(`/api/courses/${courseId}/chapters/${chapterId}/quiz/${quizId}/publish`);
                react_hot_toast_1.default.success("تم نشر النشاط");
            }
            router.refresh();
        }
        catch (_a) {
    ...
    const onDelete = () => __awaiter(void 0, void 0, void 0, function* () {
        try {
            setIsLoading(true);
            yield axios_1.default.delete(`/api/courses/${chapterId}/quiz/${quizId}`);
            react_hot_toast_1.default.success("تم حذف الاختبار");
            router.refresh();
...
exports.QuizActions = QuizActions;
