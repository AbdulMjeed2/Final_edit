...
exports.QuestionExplanationForm = void 0;
...
const QuestionExplanationForm = ({ initialData, courseId, quizId, chapterId, questionId, }) => {
    ...
    const form = (0, react_hook_form_1.useForm)({
        ...
        defaultValues: {
            explanation: (initialData === null || initialData === void 0 ? void 0 : initialData.explanation) || "",
        },
    });
    const { isSubmitting, isValid } = form.formState;
    const onSubmit = (values) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            yield axios_1.default.patch(`/api/courses/${courseId}/chapters/${chapterId}/quiz/${quizId}/questions/${questionId}`, values);
    ...
    return (<div className="mt-6 border bg-slate-100 rounded-md p-4">
      ...
      {!isEditing && (<div className={(0, utils_1.cn)("text-sm mt-2", !initialData.explanation && "text-slate-500 italic")}>
          {!initialData.explanation && "لا يوجد تفسير"}
          {initialData.explanation && (<FroalaEditorView_1.default model={form.getValues("explanation")}/>)}
        </div>)}
      {isEditing && (<form_1.Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 mt-4">
            <form_1.FormField control={form.control} name="explanation" render={({ field }) => (<form_1.FormItem>
                  <form_1.FormControl>
...
exports.QuestionExplanationForm = QuestionExplanationForm;
