...
const exam_title_form_1 = require("./_components/exam-title-form");
const exam_description_form_1 = require("./_components/exam-description-form");
const exam_actions_1 = require("./_components/exam-actions");
...
const ChapterIdPage = (_a) => __awaiter(void 0, [_a], void 0, function* ({ params, }) {
    ...
    return (<>
      {!exam.isPublished && (<banner_1.Banner variant="warning" label="هذا الامتحان غير منشور. لن يكون مرئيا في الدورة"/>)}
        ...
        <div className="flex items-center justify-between">
          <div className="w-full">
            ...
            <div className="flex items-center justify-between w-full">
              ...
              <exam_actions_1.ExamActions disabled={!isComplete} courseId={params.courseId} examId={params.examId} isPublished={exam.isPublished}/>
            </div>
          </div>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-16">
          <div className="space-y-4">
            <div>
              ...
              <exam_title_form_1.ExamTitleForm initialData={exam} courseId={params.courseId} examId={params.examId}/>
              <exam_description_form_1.ExamDescriptionForm initialData={exam} courseId={params.courseId} examId={params.examId}/>
            </div>
          </div>
          <div>
            <div className="flex items-center gap-x-2">
            ...
            <question_form_1.QuestionForm initialData={exam} examId={exam.id} courseId={params.courseId}/>
          </div>
        </div>
      </div>
    </>);
