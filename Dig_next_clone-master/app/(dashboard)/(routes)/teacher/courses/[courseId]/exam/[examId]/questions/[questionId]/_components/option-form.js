...
const OptionForm = ({ initialData, examId, courseId, questionId, }) => {
    ...
    const onSubmit = (values) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            yield axios_1.default.post(`/api/courses/${courseId}/exam/${examId}/questions/${questionId}/options`, values);
    ...
    const onReorder = (updateData) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            setIsUpdating(true);
            yield axios_1.default.put(`/api/courses/${courseId}/exam/${examId}/questions/${questionId}/options/reorder`, {
                list: updateData,
            });
    ...
    return (<div className="relative mt-6 border bg-slate-100 rounded-md p-4">
      ...
      {!isCreating && (<div className={(0, utils_1.cn)("text-sm mt-2", !initialData.options.length && "text-slate-500 italic")}>
          ...
          <option_list_1.OptionList answer={initialData.answer} courseId={courseId} examId={examId} questionId={questionId} onReorder={onReorder} items={initialData.options || []}/>
        </div>)}
