...
const QuestionForm = ({ initialData, examId, courseId, }) => {
    ...
    const onSubmit = (values) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            yield axios_1.default.post(`/api/courses/${courseId}/exam/${examId}/questions`, values);
    ...
    const onDelete = (id) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            setIsDeleting(true);
            debugger;
            yield axios_1.default.delete(`/api/courses/${courseId}/exam/${examId}/questions/${id}`);
            //deleted(id)
    ...
    const onReorder = (updateData) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            setIsUpdating(true);
            var data = updateData;
            yield axios_1.default.put(`/api/courses/${courseId}/exam/${examId}/questions/reorder`, {
                list: data,
            });
    ...
    return (<div className="relative mt-6 border bg-slate-100 rounded-md p-4">
      ...
      {!isCreating && (<div className={(0, utils_1.cn)("text-sm mt-2", !initialData.questions.length && "text-slate-500 italic")}>
          ...
          <question_list_1.QuestionList onEdit={onEdit} onReorder={onReorder} OnDelete={onDelete} items={initialData.questions || []}/>
        </div>)}
