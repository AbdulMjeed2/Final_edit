...
const QuestionActions = ({ disabled, courseId, examId, questionId, isPublished, }) => {
    ...
    const onClick = () => __awaiter(void 0, void 0, void 0, function* () {
        try {
            setIsLoading(true);
            if (isPublished) {
                yield axios_1.default.patch(`/api/courses/${courseId}/exam/${examId}/questions/${questionId}/unpublish`);
                react_hot_toast_1.default.success("سؤال غير منشور");
            }
            else {
                yield axios_1.default.patch(`/api/courses/${courseId}/exam/${examId}/questions/${questionId}/publish`);
    ...
    const onDelete = () => __awaiter(void 0, void 0, void 0, function* () {
        try {
            setIsLoading(true);
            yield axios_1.default.delete(`/api/courses/${courseId}/exam/${examId}/questions/${questionId}`);
