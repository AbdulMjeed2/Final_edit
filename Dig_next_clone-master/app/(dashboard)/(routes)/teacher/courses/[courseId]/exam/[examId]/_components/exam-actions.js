...
const ExamActions = ({ disabled, courseId, examId, isPublished, }) => {
    ...
    const onClick = () => __awaiter(void 0, void 0, void 0, function* () {
        try {
            setIsLoading(true);
            if (isPublished) {
                yield axios_1.default.patch(`/api/courses/${courseId}/exam/${examId}/unpublish`);
                react_hot_toast_1.default.success("الامتحان غير منشور");
            }
            else {
                yield axios_1.default.patch(`/api/courses/${courseId}/exam/${examId}/publish`);
                react_hot_toast_1.default.success("تم نشر الامتحان");
            }
            router.refresh();
        }
        catch (_a) {
    ...
    const onDelete = () => __awaiter(void 0, void 0, void 0, function* () {
        try {
            setIsLoading(true);
            yield axios_1.default.delete(`/api/courses/${courseId}/exam/${examId}`);
            react_hot_toast_1.default.success("تم حذف الفصل");
...
exports.ExamActions = ExamActions;
