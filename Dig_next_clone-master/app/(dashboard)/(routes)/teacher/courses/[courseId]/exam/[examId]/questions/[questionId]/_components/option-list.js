...
const OptionList = ({ answer, items, courseId, examId, questionId, onReorder, }) => {
    ...
    const onDelete = (id) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            setIsDeleting(true);
            yield axios_1.default.delete(`/api/courses/${courseId}/exam/${examId}/questions/${questionId}/options/${id}`);
    ...
    const onSubmit = (values) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            yield axios_1.default.patch(`/api/courses/${courseId}/exam/${examId}/questions/${questionId}/options/${currentOption === null || currentOption === void 0 ? void 0 : currentOption.id}`, values);
                            ...
                            <form_1.Form {...form}>
                              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 mt-4">
                                <form_1.FormField control={form.control} name="text" render={({ field }) => (<form_1.FormItem>
                                      <form_1.FormLabel>Option Text</form_1.FormLabel>
                                      <form_1.FormControl>
                                        <input_1.Input disabled={isSubmitting} defaultValue={option.text} placeholder={option.text} dir="rtl" {...field}/>
                                      </form_1.FormControl>
                                      <form_1.FormMessage />
                                    </form_1.FormItem>)}/>
