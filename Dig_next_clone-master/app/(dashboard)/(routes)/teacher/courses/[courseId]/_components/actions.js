...
const Actions = ({ disabled, courseId, isPublished }) => {
    ...
    const onClick = () => __awaiter(void 0, void 0, void 0, function* () {
        try {
            setIsLoading(true);
            if (isPublished) {
                yield axios_1.default.patch(`/api/courses/${courseId}/unpublish`);
                react_hot_toast_1.default.success("الدورة غير منشورة");
            }
            else {
                yield axios_1.default.patch(`/api/courses/${courseId}/publish`);
                react_hot_toast_1.default.success("تم نشر الدورة");
                confetti.onOpen();
            }
            router.refresh();
        }
    ...
    const onDelete = () => __awaiter(void 0, void 0, void 0, function* () {
        try {
            setIsLoading(true);
            yield axios_1.default.delete(`/api/courses/${courseId}`);
            react_hot_toast_1.default.success("تم حذف الدورة");
            router.refresh();
