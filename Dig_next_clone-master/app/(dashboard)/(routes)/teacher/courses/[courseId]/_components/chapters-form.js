...
const ChaptersForm = ({ initialData, courseId }) => {
    ...
    const onSubmit = (values) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            yield axios_1.default.post(`/api/courses/${courseId}/chapters`, values);
            react_hot_toast_1.default.success("تم إنشاء الفصل");
            toggleCreating();
            form.setValue("title", "");
            router.refresh();
        }
    ...
    const onReorder = (updateData) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            setIsUpdating(true);
            yield axios_1.default.put(`/api/courses/${courseId}/chapters/reorder`, {
                list: updateData,
            });
            react_hot_toast_1.default.success("أعيد ترتيب الفصول");
            router.refresh();
        }
        catch (_a) {
            react_hot_toast_1.default.error("هناك شئ غير صحيح");
    ...
    const onDelete = (id) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            //  setIsDeleting(true);
            debugger;
            yield axios_1.default.delete(`/api/courses/${courseId}/chapters/${id}`);
            //deleted(id)
    ...
    return (<div className="relative mt-6 border bg-slate-100 rounded-md p-4">
      ...
      {isCreating && (<form_1.Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 mt-4">
            <form_1.FormField control={form.control} name="title" render={({ field }) => (<form_1.FormItem>
                  <form_1.FormControl>
                    <input_1.Input disabled={isSubmitting} placeholder="e.g. 'مقدمة للدورة'" {...field}/>
                  </form_1.FormControl>
                  <form_1.FormMessage />
                </form_1.FormItem>)}/>
      ...
      {!isCreating && (<div className={(0, utils_1.cn)("text-sm mt-2", !initialData.chapters.length && "text-slate-500 italic")}>
          ...
          <chapters_list_1.ChaptersList onEdit={onEdit} onReorder={onReorder} OnDelete={onDelete} items={initialData.chapters || []}/>
        </div>)}
