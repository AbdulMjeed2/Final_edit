...
const ExamForm = ({ initialData, courseId }) => {
    var _a;
    ...
    const FinalExams = (_a = initialData.exams) === null || _a === void 0 ? void 0 : _a.filter((e) => e.starterExam == false);
    const onEdit = (id) => {
    ...
    return (<div className="relative mt-6 border bg-slate-100 rounded-md p-4">
      ...
      <div className="font-medium flex items-center justify-between">
        امتحان الدورة
        {!(FinalExams.length > 0) && (<button_1.Button onClick={toggleCreating} variant="ghost">
            {isCreating ? (<>إلغاء</>) : (<>
