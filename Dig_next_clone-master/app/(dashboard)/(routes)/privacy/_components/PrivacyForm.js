...
exports.PrivacyForm = PrivacyForm;
...
function PrivacyForm({ defaultContext, isTeacher }) {
    ...
    const handleSubmit = () => __awaiter(this, void 0, void 0, function* () {
        try {
            console.log(context);
            yield axios_1.default.patch(`/api/privacy`, { context: context });
            react_hot_toast_1.default.success("تم تحديث سياسة الخصوصية");
            setEditing(false);
        }
        catch (e) {
            console.log(e);
