...
const ReplyCard = ({ msg, user, messageId }) => {
    (msg);
    ...
    const handleDelete = () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        setIsPopup(false);
        try {
            const { data } = yield axios_1.default.delete(`/api/messages/${messageId}/reply/${msg.id}`);
    ...
    return (<div className={`relative flex items-start gap-2.5 w-full mb-4`} dir='rtl'>
   ...
   {(userId == user.id || (0, teacher_1.isTeacher)(userId)) && (<button onClick={e => setIsPopup(!isPopup)} id="dropdownMenuIconButton" data-dropdown-toggle="dropdownDots" data-dropdown-placement="bottom-start" className="inline-flex self-center items-center p-2 text-sm font-medium text-center text-gray-900 bg-white rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none dark:text-white focus:ring-gray-50 dark:bg-gray-900 dark:hover:bg-gray-800 dark:focus:ring-gray-600" type="button">
