...
function DELETE(req_1, _a) {
    return __awaiter(this, arguments, void 0, function* (req, { params, }) {
        try {
            ...
            const deletedQuestion = yield db_1.db.examQuestion.delete({
                where: {
                    id: params.questionId,
                },
            });
            const publishedQuestionInExam = yield db_1.db.examQuestion.findMany({
                where: {
                    examId: params.examId,
                    isPublished: true,
                },
...
function PATCH(req_1, _a) {
    return __awaiter(this, arguments, void 0, function* (req, { params, }) {
        try {
            ...
            const question = yield db_1.db.examQuestion.update({
                where: {
                    id: params.questionId,
                    examId: params.examId,
                },
