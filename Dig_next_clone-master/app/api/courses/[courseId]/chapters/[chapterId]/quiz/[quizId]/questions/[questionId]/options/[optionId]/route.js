...
function DELETE(req_1, _a) {
    return __awaiter(this, arguments, void 0, function* (req, { params, }) {
        try {
            ...
            const option = yield db_1.db.quizQuestionOption.findUnique({
                where: {
                    id: params.optionId,
            ...
            const deletedOption = yield db_1.db.quizQuestionOption.delete({
                where: {
                    id: params.optionId,
                },
            });
            const optionQuestion = yield db_1.db.quizQuestion.findUnique({
                where: {
...
function PATCH(req_1, _a) {
    return __awaiter(this, arguments, void 0, function* (req, { params, }) {
        try {
            ...
            const option = yield db_1.db.quizQuestionOption.update({
                where: {
                    id: params.optionId,
                    questionId: params.questionId,
                },
