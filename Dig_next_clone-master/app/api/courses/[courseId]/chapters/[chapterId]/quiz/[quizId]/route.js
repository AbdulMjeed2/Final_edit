...
function DELETE(req_1, _a) {
    return __awaiter(this, arguments, void 0, function* (req, { params }) {
        try {
            ...
            const deletedQuiz = yield db_1.db.quiz.delete({
                where: {
                    id: params.chapterId,
                },
            });
            const publishedQuizInChapter = yield db_1.db.quiz.findMany({
                where: {
                    chapterId: params.chapterId,
                    isPublished: true,
                },
            ...
            return server_2.NextResponse.json(deletedQuiz);
        }
        catch (error) {
...
function PATCH(req_1, _a) {
    return __awaiter(this, arguments, void 0, function* (req, { params, }) {
        try {
            ...
            const quiz = yield db_1.db.quiz.update({
                where: {
                    id: params.quizId,
                    chapterId: params.chapterId,
                },
