...
function PATCH(req) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const contextDb = yield db_1.db.libraryText.findFirst();
            if (contextDb) {
                const newContext = yield db_1.db.libraryText.update({
                    where: {
                        id: contextDb.id
                    },
                    data: {
                ...
                const newContext = yield db_1.db.libraryText.create({ data: { context: context } });
            }
