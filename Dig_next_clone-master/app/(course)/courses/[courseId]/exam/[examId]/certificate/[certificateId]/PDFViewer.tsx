...
export const PdfViewer = ({ params }: { params: { courseId: string; examId: string; certificateId: string } }) => {
    ...
    <>
      {isGettingCertificate ? (
        <div className="flex items-center justify-center h-full w-full">
          <div className="font-bold text-2xl text-slate-500 animate-pulse">...تحضير شهادتك</div>
        </div>
      ) : certificate ? (
